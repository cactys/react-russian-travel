...
export const images = [
  { id: 0, title: 'Поезд', link: train },
  { id: 1, title: 'Атхарва Тулси', link: atharvaTulsi },
  { id: 2, title: 'Туман', link: tuman },
  { id: 3, title: 'Сочи', link: sochi },
  { id: 4, title: 'Ариса', link: arisa },
  { id: 5, title: 'Байкал', link: baikalFirst },
  { id: 6, title: 'Эльюрус', link: elbrus },
  { id: 7, title: 'Кондратьево', link: kondratiev },
  { id: 8, title: 'Камчатка', link: kamchatkaFirst },
  { id: 9, title: 'Камчатка', link: kamchatkaSecond },
  { id: 10, title: 'Байкал', link: baikalSecond },
  { id: 11, title: 'Ергаки', link: ergaki },
];
